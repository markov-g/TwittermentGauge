...
let data = try MLDataTable(contentsOf: URL(fileURLWithPath: "/Users/r1pp3r/git-repos/github.com/xcode-playground/iOS13/TwittermentGauge/TwittermentGauge/model_training/twitter-sanders-apple3.csv"))

let(trainingData, testingData) = data.randomSplit(by: 0.95, seed: 5)
...
try sentimentClassifier.write(to: URL(fileURLWithPath: "/Users/r1pp3r/git-repos/github.com/xcode-playground/iOS13/TwittermentGauge/TwittermentGauge/model_training/TwitttermentGauge.mlmodel"))
